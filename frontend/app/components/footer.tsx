            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
                ...
                <div className="w-full md:w-3/5">
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-4 gap-y-6 md:justify-items-end">
                        ...
                        <a href="/autors" className="footer-link hover:text-secondary transition-all">Autors</a>
                        <a href="/audiobooks" className="footer-link hover:text-secondary transition-all">Audiobooks</a>

                        {/* Second Row */}
                        <a href="/about" className="footer-link hover:text-secondary transition-all">About</a>
                        <a href="/donations" className="footer-link hover:text-secondary transition-all">Donations</a>
                        <a href="/login" className="footer-link hover:text-secondary transition-all">Login</a>
                    </div>
